    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[400px] rounded-3xl p-0 overflow-hidden border-none">
        <div className="bg-primary p-8 text-primary-foreground text-center space-y-2">
          ...
          <DialogTitle className="text-2xl font-black tracking-tight">Bienvenue sur Avaria</DialogTitle>
          <DialogDescription className="text-primary-foreground/80">
            Rejoignez la plus grande communauté de commerce africain.
          </DialogDescription>
        </div>
            ...
            <TabsContent value="login" className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="email" placeholder="nom@exemple.com" className="pl-10 h-11 rounded-xl" />
                </div>
              </div>
              <div className="space-y-2">
                <div className="flex justify-between">
                  <Label htmlFor="password">Mot de passe</Label>
                  <Button variant="link" className="h-auto p-0 text-xs">Oublié ?</Button>
                </div>
                <div className="relative">
                  <Lock className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                  <Input id="password" type="password" className="pl-10 h-11 rounded-xl" />
                </div>
              </div>
              <Button className="w-full h-11 rounded-xl mt-4 gap-2">
            ...
            <TabsContent value="signup" className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="name" placeholder="Jean Dupont" className="pl-10 h-11 rounded-xl" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Mail className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                  <Input id="signup-email" placeholder="nom@exemple.com" className="pl-10 h-11 rounded-xl" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Lock className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                  <Input id="signup-password" type="password" className="pl-10 h-11 rounded-xl" />
                </div>
              </div>
              <Button className="w-full h-11 rounded-xl mt-4 gap-2">
